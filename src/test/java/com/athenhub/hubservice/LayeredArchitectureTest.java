...
@AnalyzeClasses(
    packages = "com.athenhub.hubservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.athenhub.hubservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.athenhub.hubservice..presentation..")
        .layer("Application")
        .definedBy("com.athenhub.hubservice..application..")
        .layer("Domain")
        .definedBy("com.athenhub.hubservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.athenhub.hubservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.athenhub.hubservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.athenhub.hubservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.athenhub.hubservice.global..")
        .should()
        .dependOnClassesThat()
